...
export async function genChartByAiUsingPOST(
  ...
  return request<API.BaseResponseBiResponse_>('/api/bi/chart/chart/gen', {
    method: 'POST',
    params: {
      ...params,
    },
...
export async function genChartByAiAsyncUsingPOST(
  ...
  return request<API.BaseResponseBiResponse_>('/api/bi/chart/gen/async', {
    method: 'POST',
    params: {
      ...params,
    },
...
export async function listMyChartByPageUsingPOST(
  ...
  return request<API.BaseResponsePageChart_>('/api/bi/chart/list', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
